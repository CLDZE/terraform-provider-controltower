...
resource "controltower_aws_account" "account" {
  ...
  organizational_unit = "Sandbox (<ou-target-id>)"

  organizational_unit_id_on_delete = "<ou-deleted-id>"
...
- `organizational_unit` (String) Name and Id of the Organizational Unit under which the account resides.
